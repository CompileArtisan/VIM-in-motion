...
(()=>{
    const e = new Error("Cannot find module '../../hooks/useTerminal'");
...
function GameScreen({ user, currentStage, completedStages, adminUnlockedStageLimit, onProgress, logActivity, onLogout }) {
    ...
    // Initialize Terminal
    const { history, currentInput, setCurrentInput, cwd, isTerminal, setIsTerminal, handleTerminalKeyDown, autocompleteOptions, autocompleteIndex } = useTerminal(user, completedStages, adminUnlockedStageLimit, {
...
//# sourceMappingURL=_0i922u1._.js.map