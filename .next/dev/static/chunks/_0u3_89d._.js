...
_s(useFirebasePlayer, "XFH4eMQQRdKf7Bii+4qFaPR7DxY=");
...
_s1(useAdminDashboard, "2064wVNtNvgF08J3EQGVhm5tz/Q=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
;
function AdminDashboard({ players, activityLogs, totalLevels, onLogout }) {
    _s();
    const timeAgo = (ts)=>{
...
;
;
function GameScreen({ user, currentStage, completedStages, onProgress, logActivity, onLogout }) {
    _s();
    ...
    const [editorMode, setEditorMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("NORMAL");
    ...
    const handleCheck = ()=>{
        if (!level) return;
        const isPass = level.check(editorText);
        if (isPass) {
            setFeedback({
                type: "success",
    ...
    const handleDismissWinner = ()=>{
        setShowWinner(false);
        if (currentStage + 1 < __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$levels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEVELS"].length) {
            onProgress(currentStage + 1, completedStages);
        }
    };
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                "data-mode": editorMode === "NORMAL" ? "NORMAL" : "-- " + editorMode + " --",
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$levels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEVELS"].map((l, i)=>{
                                    ...
                                    const isLocked = i > currentStage && !isDone;
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: currentStage + 1 < __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$levels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEVELS"].length ? `"${level.title}" complete. Ready for the next challenge?` : "You've completed all stages. You're a VIM ninja! 🥷"
                        }, void 0, false, {
                            fileName: "[project]/app/components/GameScreen.tsx",
                            lineNumber: 197,
                            columnNumber: 13
...
_s(GameScreen, "07FJu44x/lhHqzha/A+UwbXaxGs=");
_c = GameScreen;
var _c;
...
function Home() {
    ...
    const { isFirebaseReady, saveProgress, loadProgress, logActivity } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebasePlayer"])(user?.name);
    ...
    const handleLoginPlayer = async ()=>{
        ...
        // Try to load progress only if Firebase is ready
        if (isFirebaseReady) {
        // This runs after component updates but we fetch here proactively if possible,
        // However hook logic works lazily, so we rely on an effect or local storage.
        }
        setScreen("game");
    };
...
_s(Home, "pnvKlwGRutZNPAd04ng2cihfJTQ=", false, function() {
    return [
...
//# sourceMappingURL=_0u3_89d._.js.map